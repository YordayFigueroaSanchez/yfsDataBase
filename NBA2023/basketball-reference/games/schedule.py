...
# url de la data
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-october.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
for table_body_tr in table_body_trs:
    table_body_tr_ths = table_body_tr.find_all('th')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-november.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-december.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-january.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-february.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-march.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-april.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-may.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
...
schedule_link = "https://www.basketball-reference.com/leagues/NBA_2023_games-june.html"
driver.get(schedule_link)
page = BeautifulSoup(driver.page_source,'html.parser')
div_schedule = page.find('div', id='div_schedule')
table_body_trs = div_schedule.find('tbody').find_all('tr')
