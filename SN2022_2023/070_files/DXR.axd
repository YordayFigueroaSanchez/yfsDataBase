...
{
	background: url('/DXR.axd?r=1_96-J_vMl');
	height: 16px;
	width: 16px;
}
...
{
	background-image: url('/DXR.axd?r=1_103-J_vMl');
}
...
.dxpLite .dxp-dropDownButton
{
    ...
    background: #e6e6e6 url('/DXR.axd?r=1_113-J_vMl') repeat-x top;
    
}
.dxpLite .dxp-hoverDropDownButton
{
    border: 1px solid #606060;
    background: #f2f2f2 url('/DXR.axd?r=1_114-J_vMl') repeat-x top;
}
...
{
	background: #E8E7E8 url('/DXR.axd?r=1_122-J_vMl') repeat-x;
	border: 1px solid #7F7F7F;
	padding: 5px;
}
...
{
	background: #F4F4F4 url('/DXR.axd?r=1_123-J_vMl') repeat-x;
}
...
.dxtcLite > .dxtc-stripContainer .dxtc-sbDisabled
{
	cursor: default;
	border-color: #C3C3C3;
	background: #E6E7E8 url('/DXR.axd?r=1_124-J_vMl') repeat-x;
}
...
.dxucBrowseButton
{
	padding: 4px 8px 3px;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_135-J_vMl') repeat-x top;
}
...
{
	border: 1px solid #606060;
	background: #F2F2F2 url('/DXR.axd?r=1_136-J_vMl') repeat-x top;
}
...
{
	background: url('/DXR.axd?r=1_117-J_vMl') repeat;
	font-size: 0;
	line-height: 0px;
}
...
.dxtvControl .dxtv-ln
{
	background: url('/DXR.axd?r=1_118-J_vMl') repeat-y;
	vertical-align: top;
}
...
.dxtvControl .dxtv-elb
{
	background: url('/DXR.axd?r=1_119-J_vMl') no-repeat;
}
...
.dxtvControl.dxtvRtl .dxtv-elb
{
	background-image: url('/DXR.axd?r=1_120-J_vMl');
}
...
{
	width: 3px;
	background: url('/DXR.axd?r=1_125-J_vMl') repeat-y right;
	border-width: 0px;
}
...
{
    background-image: url('/DXR.axd?r=1_99-J_vMl');
...
.dxigItem
{
    background-repeat: no-repeat;
    background-position:center center;
    background-image: url('/DXR.axd?r=1_100-J_vMl');
}
.dxigItem a
{
    outline: 0;
...
{
    width: 43px;
    background: url('/DXR.axd?r=1_101-J_vMl') repeat-y;
}
.dxigControl .dxig-bottomPanel .dxis-nbBottom > .dxis-prevBtnHorWrapper
{
...
.dxrControl .dxtcLite.dxtc-top .dxr-fileTab {
    background: #e5e5e5 url('/DXR.axd?r=1_138-J_vMl') repeat-x;
    border-color: #a8a8a8;
    border-left-width: 1px;
    border-right-width: 1px;
}
.dxrControl .dxtcLite.dxtc-top .dxtc-tabHover.dxr-fileTab {
    background: #E8E7E8 url('/DXR.axd?r=1_139-J_vMl') repeat-x;
    border-color: #a8a8a8;
}
...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_178-J_vMl');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_180-J_vMl');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_179-J_vMl');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_181-J_vMl');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
	background-image:  url('/DXR.axd?r=1_166-J_vMl');
}
.dxeTBVSys .dxeTBTrack
{
	background-image:  url('/DXR.axd?r=1_165-J_vMl');
}
...
{
	background-image:  url('/DXR.axd?r=1_164-J_vMl');
}
.dxeTBVSys .dxeTBBarHighlight
{
	background-image:  url('/DXR.axd?r=1_163-J_vMl');
}
...
.dxeTBHSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_155-J_vMl');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_160-J_vMl');
}
.dxeTBVSys .dxeTBItem 
{
	background-image:  url('/DXR.axd?r=1_158-J_vMl');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem
{
	background-image:  url('/DXR.axd?r=1_159-J_vMl');
}
...
{
	background-image: url('/DXR.axd?r=1_156-J_vMl');
}
.dxeTBVSys .dxeTBSmallTick
{
	background-image: url('/DXR.axd?r=1_157-J_vMl');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_161-J_vMl');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick
{
	background-image: url('/DXR.axd?r=1_162-J_vMl');
}
...
.dxeSpinLargeDecButton
{
	background: #e6e6e6 url('/DXR.axd?r=1_175-J_vMl') repeat-x top;
}
.dxeSpinIncButton
{
	background: #F0F0F0 url('/DXR.axd?r=1_171-J_vMl') repeat-x top;
}
.dxeSpinDecButton
{
	background: #E6E6E6 url('/DXR.axd?r=1_172-J_vMl') repeat-x top;
}
.dxeCalendarButton,
.dxeColorEditButton
{
	background: #e5e5e5 url('/DXR.axd?r=1_173-J_vMl') repeat-x top;
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_176-J_vMl') repeat-x top;
	border: 1px Solid #606060;
}
.dxeSpinIncButtonHover
{
...
{
	background: #F2F2F2 url('/DXR.axd?r=1_174-J_vMl') repeat-x top;
}
.dxeCalendarButtonHover,
.dxeColorEditButton:hover
{
...
.dxbButton
{
	...
	font: 12px Tahoma, Geneva, sans-serif;
	border: 1px solid #7F7F7F;
	background: #E0DFDF url('/DXR.axd?r=1_169-J_vMl') repeat-x top;
	padding: 1px;
}
.dxbButtonHover
{
	color: #000000;
	background: #F2F2F2 url('/DXR.axd?r=1_170-J_vMl') repeat-x top;
	border: 1px solid #606060;
}
.dxbButtonChecked
{
...
{
    background: url('/DXR.axd?r=1_92-J_vMl') no-repeat;
    float: left;
    height: 21px;
    vertical-align: top;
    width: 26px;
...
{
    background: url('/DXR.axd?r=1_93-J_vMl') no-repeat;
    float: right;
	margin-right: 0;
    margin-left: 0.3em;
...
.dxfcControl .dxfc-ln
{
    background: url('/DXR.axd?r=1_91-J_vMl') repeat-y;
    vertical-align: top;
}
...
{
	background-image: url('/DXR.axd?r=1_96-J_vMl');
	height: 16px;
	width: 16px;
}
.dxpcLite .dxHFBPS
...
.dxeToken {
	background: #ececec url('/DXR.axd?r=1_177-J_vMl') repeat-x top;
}
