...
for elementDate in listOfDate:
    ...
    parameterDate = elementDate
    url = "https://api.sportsdata.io/v3/mlb/scores/json/GamesByDate/"+ parameterDate +"?key=87172a8552914404994259782b1d8551"
    ...
    nombre_archivo = parameterDate +'.json'
