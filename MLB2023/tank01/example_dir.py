...
# Combinar el directorio "game" con el nombre del archivo para obtener la ruta completa
ruta_archivo_guardado = os.path.join(directorio_actual, nombre_directorio, nombre_archivo)
