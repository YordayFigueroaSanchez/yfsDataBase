...
# Sustituye por tu ruta real
# ruta_chrome_driver = 'C:/Users/yfigueroa/Documents/GitHub/yfsDataBase/chromedriver.exe'  
...
# url de la data
schedule_link = "https://www.baseball-reference.com/leagues/majors/2024-schedule.shtml"
...
div_schedule = page.find('div', id='div_4796705278')
...
for div in divs:
    ...
    for i,div_p in enumerate(div_ps):
        if div_p is not None and "Boxscore" in div_p.text:
            print("El div contiene el texto 'Boxscore'")
            ...
            print("El div no contiene el texto 'Boxscore'")
